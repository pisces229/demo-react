...
import {
  DemoContextContextModel,
  DemoContextContext,
} from "./demo-context-context";
...
export class DemoContextComponent extends React.Component<
  {},
  DemoContextContextModel,
  {}
> {
  ...
  render() {
    return (
      <DemoContextContext.Provider value={this.state}>
        ...
        >
          TestComponent Provider:[{this.state.count}]
        </button>
