...
const DemoDefaultLazyComponent = lazy(() =>
  import('./demo-default-lazy-component')
    .then((module) => ({ default: module.DemoDefaultLazyComponent })),
);
// ----- Welcome -----
...
class PropStateFirst extends React.Component<{value: string},{value: string}> {
  private timer!: NodeJS.Timer;
...
class PropStateSecond extends React.Component<{value: string},{value: string}> {
  private timer!: NodeJS.Timer;
  constructor(props: {value: string}) {
    super(props);
    this.state = { value: '' };
  ...
  render() {
    ...
    <form onSubmit={this.formSubmit}>
      <label>
        ...
        <br/>
        Check:
        <input type='checkbox' value={this.state.input} onChange={this.checkboxChange} />
        <br/>
      </label>
...
class TemperatureMain extends React.Component<{},{scale: string, temperature: string}> {
  constructor(props: {}) {
    super(props);
  ...
  render() {
    ...
    return (
    <div>
      <TemperatureInput scale="c" temperature={celsius} onTemperatureChange={this.celsiusChange} />
      <TemperatureInput scale="f" temperature={fahrenheit} onTemperatureChange={this.fahrenheitChange} />
...
class TemperatureInput extends React.Component<
  ...
  {}
>{
  constructor(props: {scale: string, temperature: string, onTemperatureChange: Function}) {
    super(props);
    this.state = {};
  }
  change = (event: React.ChangeEvent<HTMLInputElement>) => this.props.onTemperatureChange(event.target.value);
  render() {
