...
const Index = () => {
  ...
  const onClickGet = async () => {
    await AppService.get()
      ...
      .finally(() => console.log(`AppService.get.finally`));
  };
  const onClickPost = async () => {
    await AppService.post()
      ...
      // .catch((error) => console.log(error))
      .finally(() => console.log(`AppService.post.finally`));
  };
  ...
  const onClickDownload = async () => {
    AppService.download({ filename: 'test' })
      ...
      .then((response) => {
        return FileUtil.axiosResponseDownload(response);
        // return FileUtil.axiosResponseOpen(response);
      })
